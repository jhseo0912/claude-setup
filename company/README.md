...
| skills/company/templates | org.md(직급표, 운영 규칙), session-protocol.md(카드 형식), roster.md, personas.md, meeting-logs, roles, plans, ADR |
...
| hooks/group-lead-sheet.sh | 그룹장 세션에만 주업무 다섯 줄 주입 |
...
| 기본값. 회의 4시간과 1시간, 카드 상한, 커밋 창 | 기본값을 바꾸면 org.md에 덮어씀 |
